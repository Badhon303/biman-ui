...
export function SettingsPage(){
  ...
  const customStartHours = sliderServices[serviceLevel]?.maxHours ?? 500
  ...
  const addCustomService = () => {
    setCustomServices((services) => [...services, { id: `custom-${Date.now()}`, name: '', minHours: String(customStartHours), maxHours: '' }])
  }
