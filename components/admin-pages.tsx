...
export function SettingsPage(){
  ...
  const saveEquipmentType = () => {
    ...
    setEquipmentTypes((types) => editingType
      ...
      : [...equipmentTypes, { id: `et-${Date.now()}`, name, services }])
