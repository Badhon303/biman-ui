...
import { equipment, tickets as ticketData } from '@/lib/mock-data'
const status=[
...
const tickets=[
  {name:'PM',value:ticketData.filter((ticket)=>ticket.serviceType==='Preventive Maintenance').length},
  {name:'Breakdown',value:ticketData.filter((ticket)=>ticket.serviceType==='Breakdown Maintenance').length},
  {name:'General',value:ticketData.filter((ticket)=>ticket.serviceType==='General Maintenance').length},
  {name:'Washing',value:ticketData.filter((ticket)=>ticket.serviceType==='washing').length},
  {name:'Scheduled',value:ticketData.filter((ticket)=>ticket.serviceType==='scheduled').length},
]
