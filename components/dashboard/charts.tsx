...
const colors=['#2667ff','#f59e0b','#f43f5e','#94a3b8']
const tickets=[
  {name:'PM',value:ticketData.filter((ticket)=>ticket.type==='Preventive Maintenance').length},
  {name:'Breakdown',value:ticketData.filter((ticket)=>ticket.type==='Breakdown Maintenance').length},
  {name:'General',value:ticketData.filter((ticket)=>ticket.type==='General Maintenance').length},
  {name:'Washing',value:ticketData.filter((ticket)=>ticket.type==='Washing Schedule').length},
]
